...
CKEDITOR.plugins.add('pyroimages',
{
    ...
    init : function(editor)
    {
		...
		CKEDITOR.dialog.addIframe('pyroimage_dialog', 'Upload or insert images from gallery', SITE_URL + 'admin/galleryeditor/0',1200,500,function(){}, {
			onLoad: function(){
        ...
        editor.ui.addButton('pyroimages',{ label:'Upload or insert images from gallery', command:'pyroimages', icon:this.path+'images/icon.png' });
