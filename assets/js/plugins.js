$(document).ready(function(){
    ...
    /* Datetimepicker */
    if($(".datetimepicker").length > 0) $(".datetimepicker").datetimepicker({nextText: "", prevText: "",dateFormat: 'yy-mm-dd'});
    /* EOF Datetimepicker */    
   ...
   /* if($("table.sortable_simple").length > 0)
    ...
    if($("input[class^='mask_']").length > 0){
        ...
        $("input.mask_ssn").mask('999.999.999');        
    ...
    /* slider example(demo) */
    $("#spinner,#price_spinner1,#price_spinner2,#price_spinner3,#price_spinner4,#price_spinner5,#price_spinner6,#price_spinner7,#price_spinner8,#price_spinner9,#price_spinner10,#price_spinner11, #price_spinner12, #price_spinner13, #price_spinner14, #price_spinner15, #price_spinner16, #price_spinner17, #price_spinner18, #price_spinner19, #price_spinner20, #price_spinner21, #price_spinner22, #price_spinner23, #price_spinner24, #price_spinner25, #price_spinner26, #price_spinner27, #price_spinner28, #price_spinner29, #price_spinner30, #price_spinner31, #price_spinner32, #price_spinner33, #price_spinner34, #price_spinner35, #price_spinner36, #price_spinner37, #price_spinner38, #price_spinner39, #price_spinner40, #price_spinner41, #price_spinner42, #price_spinner43, #price_spinner44, #price_spinner45,#price_spinner46, #price_spinner47, #price_spinner48, #price_spinner49, #price_spinner50, #price_spinner51, #price_spinner52, #price_spinner53").spinner();
