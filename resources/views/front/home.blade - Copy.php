  ...
  background-color: #5cb85c; }
   ...
   @endif
       {!! Form::open(['url'=> 'quote', 'id'=>'basicform', 'name'=>'basicform']) !!}
        ...
        <div class="col-md-12">        
        <h4>EasyCleanUp kan uw partner zijn voor de inzet van:</h4>
        </div>
...
<td align="center"><div class="checkbox checkbox-primary" style=" margin-bottom: 0px;margin-top: 0px;">
                        <input id="checkbox1" type="checkbox" checked="" value="Yes" name="3m3">
                        <label for="checkbox1" style="vertical-align:top;"> </label> </div></td>
<td>6m3</td>
<td align="center"><div class="checkbox checkbox-primary" style=" margin-bottom: 0px;margin-top: 0px;">
                        <input id="checkbox2" type="checkbox" checked="" value="Yes" name="6m3">
                        <label for="checkbox2" style="vertical-align:top;"> </label> </div></td>
<td>10m3</td>
<td align="center"><div class="checkbox checkbox-primary" style=" margin-bottom: 0px;margin-top: 0px;">
                        <input id="checkbox3" type="checkbox" checked="" value="Yes" name="10m3">
...
<td align="center" ><div class="checkbox checkbox-primary" style=" margin-bottom: 0px;margin-top: 0px;">
     ...
     <!--   <div class="col-md-4">
        <div class="form-group">
        <label>3m<sup>3</sup></label>
        <input type="text" class="form-control" id="3m3" name="3m3"/>
        </div>
        </div>
        
        <div class="col-md-4">
        <div class="form-group">
        <label>6m<sup>3</sup></label>
        <input type="text" class="form-control" id="6m3" name="6m3"/>
        </div>
        </div>
        
        <div class="col-md-4">
        <div class="form-group">
        <label>10m<sup>3</sup></label>
        <input type="text" class="form-control" id="10m3" name="10m3"/>
        </div>
        </div>
        
        <div class="col-md-4">
        <div class="form-group">
        <label>Bouwopruimer</label>
        <input type="text" class="form-control" id="bouwopruimer" name="bouwopruimer"/>
        </div>
        </div>
        ...
        <input type="text" class="form-control" id="handyman" name="handyman"/>
        </div>
        </div>
        
        <div class="col-md-4">
        <div class="form-group">
        <label>Koffiedame</label>
        <input type="text" class="form-control" id="koffiedame" name="koffiedame"/>
        </div>
        </div>
        
        <div class="col-md-4">
        <div class="form-group">
        <label>Afvalagent</label>
        <input type="text" class="form-control" id="afvalagent" name="afvalagent"/>
        </div>
        </div>
        
        <div class="col-md-4">
        <div class="form-group">
        <label>Betonafwerker</label>
        <input type="text" class="form-control" id="betonafwerker" name="betonafwerker"/>
        </div>
        </div>
        
        <div class="col-md-4">
        <div class="form-group">
        <label>Aanpiccalateur</label>
        <input type="text" class="form-control" id="aanpiccalateur" name="aanpiccalateur"/>
        </div>
        </div>
                 
        <div class="col-md-4">
        <div class="form-group">
        <label>Magazijnbeheerder</label>
        <input type="text" class="form-control" id="magazijnbeheerder" name="magazijnbeheerder"/>
        </div>
        </div>
        
        <div class="col-md-4">
        <div class="form-group">
        <label>Verkeersregelaar</label>
        <input type="text" class="form-control" id="verkeersregelaar" name="verkeersregelaar"/>
        </div>
        </div>
        
        <div class="col-md-4">
        <div class="form-group">
        <label>Poortwachter/Beveiliger</label>
        <input type="text" class="form-control" id="poortwachter" name="poortwachter"/>
        </div>
        </div>
        
        <div class="col-md-4">
        <div class="form-group">
        <label>Glazenwasser</label>
        <input type="text" class="form-control" id="glazenwasser" name="glazenwasser"/>
        </div>
        </div>
        ...
        <div class="form-group">
        <label>Liftbot</label>
        <input type="text" class="form-control" id="liftbot" name="liftbot"/>
        </div>
        </div>
        
        <div class="col-md-4">
        <div class="form-group">
        <label>Kantelsysteen (gratis)</label>
        <input type="text" class="form-control" id="kantelsysteen" name="kantelsysteen"/>
        </div>
        </div>
        
        <div class="col-md-4">
        <div class="form-group">
        <label>Rolcontainers (gratis)</label>
        <input type="text" class="form-control" id="rolcontainers" name="rolcontainers"/>
        </div>
        </div>
        <div class="col-md-4">
        <div class="form-group">
        <label>Professionele Stofzuigers (gratis)</label>
        <input type="text" class="form-control" id="professionele" name="professionele"/>
        </div>
        </div>
        <div class="col-md-4">
        <div class="form-group">
        <label>Kwaliteitsbewaker (gratis)</label>
        <input type="text" class="form-control" id="kwaliteitsbewaker" name="kwaliteitsbewaker"/>
        </div>
        </div>-->
