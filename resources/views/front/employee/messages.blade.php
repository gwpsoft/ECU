...
function Edit (msg_id) {
   ...
   <div class="page-content">
                ...
                <div style="margin:1%;"></div> 
                 <div class="col-lg-12">
                <a href="<?php echo URL:: to( 'add-per-messages/');?>" title="Berichten" class="btn btn-success" style="float:right">
               Nieuw bericht</a>
               <br /><br />
...
<th>Options</th>
   ...
   <td>
    ...
    <input type="hidden" id="client_<?php echo $Message->msg_id?>" value="<?php echo $Message->emp_id?>" />
    <input type="hidden" id="project_<?php echo $Message->msg_id?>" value="<?php echo $Message->project_id?>" />
    
   
   
   <a href="<?php echo URL:: to( 'view-per-message/'. $Message->msg_id );?>" title="Bericht"><span class="fa fa-chat"></span><img class="img-border img-thumbnail" src="{{ URL::asset('assets/frontend/img/chat.png') }}" style="width:30px; height:30px;"></a>

   <?php if ($Message->sender_id == Session::get('contact_id')) {?>
   
         <a href="<?php echo URL:: to( 'Del-per-message/'. $Message->msg_id );?>" title="Verwijderen" onclick="return confirm('Bent u zeker dat u dit wilt Werknemer verwijderen?');"><span class="fa fa-remove"></span><img class="img-border img-thumbnail" src="{{ URL::asset('assets/frontend/img/remove.png') }}" style="width:30px; height:30px;"></a>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                 ...
                 {!! Form::open(['url'=> 'UpdatePerMessage']) !!}
