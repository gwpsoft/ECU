  ...
  .weekcard table,td,th {
    ...
    table  {
      ...
      <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" style="-webkit-font-smoothing: antialiased; width: 100% !important;  -webkit-text-size-adjust: none;">
        ...
        @foreach ($distinctProjects as $p)
          <div class="row">
            <div class="col-md-12">
              <h3 style="margin-left: 5px; font-size: 12px;"><strong><strong>{{ $p->Project_Name }} - {{ $p->department }}</strong></strong></h3>
            </div>
          </div>
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tbody>
                  ...
                  <?php
                    ...
                    foreach ($data as $d) {
                      if($d->Project_Name == $p->Project_Name) {
                        $dataNew->append($d);
                      }
                    }
                  ?>
