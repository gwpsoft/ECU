                            ...
                            @foreach ($EMPDATA as $item)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div id="total-timecard__" class="total">0.00</div>
                                    </td>

                                    <td><input type="text" id="rate" class="form-control" style="padding:2px;"
                                               name="rate[]" /></td>

                                    <td><input type="text" id="rate_cost" class="form-control" style="padding:2px;"
                                               name="rate_cost[]" /></td>
