...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" style="-webkit-font-smoothing: antialiased; width: 100% !important;  -webkit-text-size-adjust: none;">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top:-10px;">
      ...
      <p class="center" style="line-height:4px;">WEEKSTAAT</p>
       ...
       <td width="30%" ><span style="margin-left:10px;text-align:left;font-size:12px">OPDRACHTGEVER:</span></td>

       <td width="65%"><?=$week_details[0]->Department_Name?></td>
       ...
       <td width="30%" ><span style="margin-left:10px;text-align:left;font-size:12px">WEEK NUMMER:</span></td>

       <td width="60%"><?php echo $value = substr($week_details[0]->Weeknumber, 0, -2).'-'.substr($week_details[0]->Weeknumber, -2); ?></td>
       ...
       <td width="30%" ><span style="margin-left:10px;text-align:left; font-size:12px">PROJECTNAAM:</span></td>

       <td width="60%"><?=$week_details[0]->Project?></td>
       ...
       <td width="30%" ><span style="margin-left:10px;font-size:12px">KLANT PROJ. NR.:</span></td>

       <td width="60%"><?=$week_details[0]->Customer_Ref?>&nbsp;</td>

       </tr>

        <tr>

       <td width="30%" ><span style="margin-left:10px;font-size:12px">ECU PROJECT/DEBITEUR #:</span></td>

       <td width="60%"><?=$week_details[0]->Project_Ref?>&nbsp;</td>

       </tr>
		 <tr>

       <td width="30%" ><span style="margin-left:10px;font-size:12px">WEEKSTAAT ID:</span></td>
...
<?php } ?>
        ...
        <td width="5%">Handtekening:</td>

        <td style="border-bottom: 1px solid black;" width="20%">&nbsp;</td>

        <td width="5%">&nbsp;</td>

         <td width="5%">Uitvoerder:</td>

        <td width="20%" style="border-bottom: 1px solid black; margin-left:10px; "><?=$week_details[0]->contact_firstname.' '.$week_details[0]->contact_lastname?></td>
        ...
        <td style="border-bottom: 1px solid black;" width="20%">&nbsp;</td>
         ...
         <td width="5%">Mobilenummer:</td>

        <td width="20%" style="border-bottom: 1px solid black; margin-left:10px; "><?=$week_details[0]->contact_mobile;?></td>
  ...
  <tr>
        ...
        <td colspan="3" width="25%">&nbsp; </td>
         ...
         <td width="15%">E-mail adres:</td>

        <td width="30%" style="border-bottom: 1px solid black; margin-left:10px; "><?=$week_details[0]->contact_email?></td>
   ...
   <tr>
        ...
        <td colspan="3" width="25%">&nbsp; </td>
         ...
         <td width="15%">Project Adres:</td>

        <td width="30%" style="border-bottom: 1px solid black; margin-left:10px; "><?=$week_details[0]->Project_address?></td>
   ...
   <tr>
        ...
        <td width="30%" style="border-bottom: 1px solid black; margin-left:10px; "><?=$week_details[0]->Project_city?></td>
