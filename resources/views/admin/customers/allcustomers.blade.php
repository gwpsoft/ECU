...
<script>  
 ...
 <title>List of Klant</title>   
     <div class="row">
            <div class="col-md-12">
                <ol class="breadcrumb">
                    <li><a href="<?php echo URL:: to( 'admin/dashboard' ); ?>">Huis</a></li>
                    <li class="active">List of Klant</li>
                </ol>
            </div>
        </div> 
        <div class="row">     
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" class="table table-bordered table-striped sortable">
                            ...
                            @foreach($data as $key => $value)
                                <tr>
                                    ...
                                    <td>{{ $value->Id }}</td>
                                    <td>{{ $value->Name }} </td>
                                  <td>{{ str_limit($value->Notes , 20) }}</td>
                                
                                     <td>
                                     <a href="<?php echo URL:: to( 'admin/view_customer',$value->Id ); ?>" title="uitzicht" class="widget-icon"><span class="icon-eye-open"></span></a>
                                     
                                    <a href="<?php echo URL:: to( 'admin/edit_customer',$value->Id ); ?>" title="Bewerk" class="widget-icon"><span class="icon-pencil"></span></a>
                                       <a href="<?php echo URL:: to( 'admin/delete_customer',$value->Id ); ?>" title="verwijderen" class="widget-icon" onclick="return confirm('Bent u zeker dat u deze klant wilt verwijderen?');"><span class="icon-trash"></span></a>
