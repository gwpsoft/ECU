...
<style>
 ...
 .error { color:#fff; }
    ...
    {!! Form::open(['url'=> 'admin/update_comment']) !!}
<input type="hidden" name="id" value="{{ $Get_Comment->id }}">
   <div class="col-md-12">
    ...
    <div class="col-md-8">
                ...
                <div class="form-row">
                            ...
                            <div class="col-md-7"> 
                            	...
                            	<input type="text" class="form-control" placeholder="Commentaar" name="comments" value="{{ $Get_Comment->comments }}">
