...
table th,td { font-size:12px;}
 ...
 @if (Session::has('message'))
            ...
            <div class="block">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-7">{{ $data->Location }}
                            </div>
                        </div>
                    </div>
                </div>
          ...
          <?php } }?>
                ...
                <div class="block">
                   ...
                   <div class="form-row">
                            ...
                            <div class="col-md-3">
                           		<input type="radio" id="per_keer" name="prijsafspraak" disabled="disabled" value="0" <?php if ($data->prijsafspraak == 0){?> checked="checked" <?php } ?>/>
                            Per keer
                            </div>
                             <div class="col-md-3">
                            	<input type="radio" name="prijsafspraak" id="per_uur" disabled="disabled" value="1" <?php if ($data->prijsafspraak == 1){?> checked="checked" <?php } ?>/>
                            Per uur
                            </div>
                     ...
                     <?php if ($data->prijsafspraak == 0){ $displayweek = 'block';} else { $displayweek = 'none';} ?>
                    ...
                    <div class="form-row" id="number_times" style="display:<?php echo $displayweek?>">
                     ...
                     <div class="form-row" id="eenheid" style="display:<?php echo $displayweek?>">
                            ...
                            <div class="col-md-3">
                           		<input type="radio" name="unit" id="per_stand" value="0" disabled="disabled" <?php if ($data->unit == 0){?> checked="checked" <?php } ?> />
                            Prijs per unit
                            </div>
                             <div class="col-md-3">
                            	<input type="radio" name="unit" id="per_project" value="1" disabled="disabled" <?php if ($data->unit == 1){?> checked="checked" <?php } ?>/>
                            Prijs per project
                            </div>
                             </div>
                    ...
                    <?php if ($data->unit == 0 && $data->prijsafspraak == 0){ $display = 'block';} else { $display = 'none';} ?>
  ...
  <tbody>
   ...
   <tr>
  <td>Rolcontainer:</td>
  <td> <div class="col-md-10">{{ @$pricelist->rl_pr_bsa }} € </div>   </td>
  <td> <div class="col-md-10"> {{ @$pricelist->rl_sl_bsa }} € </div>   </td>
  <td>  <div class="col-md-10">{{ @$pricelist->rl_pr_hout  }} € </div>   </td>
  <td>  <div class="col-md-10">{{@$pricelist->rl_sl_hout  }} € </div>   </td>
  <td> <div class="col-md-10">{{@$pricelist->rl_pr_puin  }} € </div> </td>
  <td> <div class="col-md-10">{{@$pricelist->rl_sl_puin  }} € </div> </td>
  ...
  <td>30m<sup>3</sup>:</td>
  <td><div class="col-md-10"> {{ @$pricelist->rl_pr_30m3_bsa}} € </div> </td>
  <td><div class="col-md-10"> {{ @$pricelist->rl_sl_30m3_bsa}} € </div> </td>
  <td><div class="col-md-10">{{ @$pricelist->rl_pr_30m3_hout}} € </div></td>
  <td><div class="col-md-10"> {{ @$pricelist->rl_sl_30m3_hout}} €</div></td>
  <td><div class="col-md-10">{{ @$pricelist->rl_pr_30m3_puin}} €</div> </td>
  <td><div class="col-md-10"> {{ @$pricelist->rl_sl_30m3_puin}} €</div> </td>
  </tr>
