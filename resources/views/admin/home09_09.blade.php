                                                                            ...
                                                                            <div class="widget-content p-0">
                                                                                <div class="widget-content-wrapper">
                                                                                    ...
                                                                                    <div class="widget-content-left flex2">
                                                                                        <div class="widget-heading">{{$service->Name}} <div class="badge badge-danger ml-2">{{$service->Status ? ($service->Status != 1) : "Open" }}</div>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="widget-content-right"> <a href="<?php echo URL::to('admin/View_OrderServices/'.$service->id); ?>" class="border-0 btn-transition btn btn-outline-success"> <i class="fa fa-eye"></i></a>
                                                                                        <a href="<?php echo URL::to('admin/Edit_OrderServices/'.$service->id); ?>" class="border-0 btn-transition btn btn-outline-primary"> <i class="fa fa-pencil"></i></a></div>
                                                                                </div>
                                                                            </div>
                                                                        </li>
                                                                        ...
                                                                        <li class="list-group-item">
                                                                            ...
                                                                            <div class="widget-content p-0">
                                                                                <div class="widget-content-wrapper">
                                                                                    ...
                                                                                    <div class="widget-content-left flex2">
                                                                                        <div class="widget-heading">{{$Order->Name ? $Order->Name : "No project selected"}} <div class="badge badge-primary ml-2">{{$Order->Status ? ($Order->Status != 1) : "Open" }}</div>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="widget-content-right"> <a href="<?php echo URL::to('admin/View_OrderWasteContainer/'.$Order->id); ?>" class="border-0 btn-transition btn btn-outline-success"> <i class="fa fa-eye"></i></a>
                                                                                        <a href="<?php echo URL::to('admin/Edit_OrderWasteContainer/'.$Order->id); ?>" class="border-0 btn-transition btn btn-outline-primary"> <i class="fa fa-pencil"></i></a></div>
                                                                                </div>
                                                                            </div>
                                                                        </li>
                                                                        ...
                                                                        <li class="list-group-item">
                                                                            ...
                                                                            <div class="widget-content p-0">
                                                                                <div class="widget-content-wrapper">
                                                                                    ...
                                                                                    <div class="widget-content-left flex2">
                                                                                        <div class="widget-heading"> <?php @$GetCustomerName = DB::table('tblcontact')->where('Id',@$Message->client_id)->first();?> <?php echo  @$GetCustomerName->Firstname.' '.@$GetCustomerName->Lastname ; ?> <div class="badge badge-success ml-2">{{$Message->status ? ($Message->status != 1) : "New" }}</div>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="widget-content-right"> <a href="<?php echo URL::to('admin/view_Berichten/'.$Message->msg_id); ?>" class="border-0 btn-transition btn btn-outline-success"> <i class="fa fa-eye"></i></a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </li>
