                            ...
                            @foreach($data as $key => $value)
                                <tr>
                                    ...
                                    <td>{{ $value->Lastname }}</td>
                                     <td>{{ $value->Phone }}</td>
                                     <td>
<a href="<?php echo URL:: to( 'admin/project_manager',$value->Id ); ?>" title="uitzicht" class="widget-icon"><span class="icon-eye-open"></span></a>
<a href="<?php echo URL:: to( 'admin/edit_project_manager',$value->Id); ?>" title="Bewerk" class="widget-icon"><span class="icon-pencil"></span></a> <a href="<?php echo URL:: to( 'admin/delete_project_manager',$value->Id ); ?>" title="verwijderen" class="widget-icon" onclick="return confirm('Weet je zeker dat je dit Project Manager verwijderen?');"><span class="icon-trash"></span></a>
