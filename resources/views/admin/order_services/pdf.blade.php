...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" style="-webkit-font-smoothing: antialiased; width: 100% !important;  -webkit-text-size-adjust: none;">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" id="firstTable" style="border: none;">
        ...
        <img src="<?php //echo url();?>/var/www/html/app/assets/img/icons/logo_sm.png" style=" vertical-align:top; height:75px; margin-bottom:10px;"  />
		<img src="<?php //echo url();?>/var/www/html/app/assets/img/icons/easycleanup_logo_large.jpg" style=" vertical-align:top; width:400px; height:80px;"  />
