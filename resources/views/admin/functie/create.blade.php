...
<style>
 ...
 .error { color:#fff; }
     ...
     <div class="row">
            <div class="col-md-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Functie Creëren</li>
                </ol>
            </div>
        </div> 
    ...
    {!! Form::open(['url'=> 'admin/functie_store']) !!}
   <div class="col-md-12">
   ...
   @endif
    <div class="col-md-8">
                ...
                <div class="form-row">
                            ...
                            <div class="col-md-7"> 
                            	<input type="text" class="form-control" placeholder="Functienaam" name="name" value="{{ (Input::old('name')) ? Input::old('name') : '' }}">
