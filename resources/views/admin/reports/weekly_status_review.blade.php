...
<script>  
		...
		$( "#search" ).click(function() {
			...
			document.location.href="<?=URL:: to( 'admin' )?>/report/weekcardoverviewchecked/weeknumber/" + year + week;
 ...
 <title>Report</title>   
   ...
   <div class="block">
    ...
    for ($i=-2; $i<=2; $i++) {
        ...
        echo '<a href="' . URL:: to( 'admin' ) . '/report/weekcardoverviewchecked' . '/weeknumber/' . $weeknumber . '"><span class="weeknr_' . $class . '" id="year">' . $weeknumber . '</span></a>';
   ...
   <div class="block">
                    ...
                    <div class="content">
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" class="table table-bordered table-striped sortable">
                                ...
                                <tr>
                                   ...
                                   <th width="5%">Weekstaat</th>
                                      ...
                                      <th width="5%">Vr</th>
                                       ...
                                       <th width="10%">Totaal Uren </th                        

                                ></tr>

                            </thead>

                            <?php if ($WeekcardOverView){  ?>

                             <tbody>

							<?php foreach ($WeekcardOverView as $WeekCard){ ?>                          
                            ...
                            <td><?php echo($WeekCard->Mon > 0 ? '<span class="label label-success">'.$WeekCard->Mon.'</span>' : $WeekCard->Mon); ?></td>

                            <td><?php echo($WeekCard->Tue > 0 ? '<span class="label label-success">'.$WeekCard->Tue.'</span>' : $WeekCard->Tue); ?></td>

                            <td><?php echo($WeekCard->Wed > 0 ? '<span class="label label-success">'.$WeekCard->Wed.'</span>' : $WeekCard->Wed); ?></td>

                            <td><?php echo($WeekCard->Thu > 0 ? '<span class="label label-success">'.$WeekCard->Thu.'</span>' : $WeekCard->Thu); ?></td>

                            <td><?php echo($WeekCard->Fri > 0 ? '<span class="label label-success">'.$WeekCard->Fri.'</span>' : $WeekCard->Fri); ?></td>

                            <td><?php echo($WeekCard->Sat > 0 ? '<span class="label label-success">'.$WeekCard->Sat.'</span>' : $WeekCard->Sat); ?></td>

                            <td><?php echo($WeekCard->Sun > 0 ? '<span class="label label-success">'.$WeekCard->Sun.'</span>' : $WeekCard->Sun); ?></td>

                            <td><?php echo($WeekCard->Total_Hours > 0 ? '<span class="label label-success">'.$WeekCard->Total_Hours.'</span>' : $WeekCard->Total_Hours); ?></td>
