...
<script>  
        ...
        (function($) {
			...
			$( "#search" ).click(function() {
			 ...
			 if (filter !=''){			
			document.location.href="<?=URL:: to( 'admin' )?>/report/hist_project_employee/filter/" + filter;
			 }
			 else {
				 document.location.href="<?=URL:: to( 'admin/report/hist_project_employee/filter' )?>";
			 }
	});
                    ...
                    <div class="content">
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" class="table table-bordered table-striped sortable">
							...
							<?php foreach ($HistoryEmployeeProject as $Project){ ?>                        
                                <tr>
                                    <td class="active_<?=$Project->Employee_Active?>"><a href="<?php echo URL:: to( 'admin/employee',$Project->Employee_Id ); ?>"><?php echo  $last_employee !=  $Project->Employee_Id ?  $Project->Name : ''; ?></a></td>
                                    <td class="active_<?=$Project->Project_Active?>"><a href="<?php echo URL:: to( 'admin/show_project',$Project->Project_Id ); ?>"><?=$Project->Project?></a></td>
                                    <td><?=$Project->Final_Week?></td>
                                </tr>
                                <?php 
								
								 $last_employee = $Project->Employee_Id;
