...
<div class="row">
  ...
  <div class="col-md-12">
    ...
    <input type="hidden" name="Employmentagency_Id" value="<?=$EmployeeAgency[0]->Employmentagency_Id?>" />
    ...
    <div class="col-md-6">
      ...
      <div class="block">
        ...
        <div class="content controls">
          <div class="form-row">
            <div class="col-md-2">
              <input type="checkbox" checked="checked" value="1" name="sendmail[<?=$EmployeeAgency[0]->Employmentagency_Id?>]" style="float:left"/></div>

              <div class="col-md-4"><?=$EmployeeAgency[0]->Employmentagency_contact?></div>
              <div class="col-md-6">(<?=$EmployeeAgency[0]->Employmentagency_email?>)</div>
            </div>
          </div>
        </div>
            ...
            <div class="form-row">
              <div class="col-md-12">
                <textarea class="form-control" rows="8"  name="Text" style="height:300px">
                  Beste [<?=$EmployeeAgency[0]->Employmentagency_contact?>],

                  Bij deze ontvangt u de weekstaat voor week [<?=$weeknumber?>].
