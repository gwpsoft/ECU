                            ...
                            @foreach($data as $key => $value)
                                <tr>
                                    ...
                                    <td>{{ $value->Lastname }}</td>
                                     <td>{{ $value->Phone }}</td>
                                     <td>
 <a href="<?php echo URL:: to( 'admin/view_contact',$value->Id);?>" title="uitzicht" class="widget-icon"><span class="icon-eye-open"></span></a>
 <a href="<?php echo URL:: to( 'admin/edit_contact',$value->Id); ?>" title="Bewerk" class="widget-icon"><span class="icon-pencil"></span></a>
 <a href="<?php echo URL:: to( 'admin/delete_contact',$value->Id); ?>" title="verwijderen" class="widget-icon" onclick="return confirm('Bent u zeker dat u deze contactpersoon te verwijderen ?');"><span class="icon-trash"></span></a>
