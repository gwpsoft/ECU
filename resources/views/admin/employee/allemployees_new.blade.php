...
<?php if (@$id == 'Active') {  ?>
        ...
        "ajax": "{{ route('datatable.getActiveEmp') }}",
		 "order": [[ 0, "desc" ]],
        "columns": [
			...
			{data: 'Sofinumber', name: 'Sofinumber'},
	...
	$('.heading,.active').html('Lijst van de inactieve personeel');
	...
	oTable = $('#employee').DataTable({
        ...
        "serverSide": true,
				"language": {
			"search": "Zoeken in de inactieve personeel:"
		  },

        "ajax": "{{ route('datatable.getInactiveEmp') }}",
		 "order": [[ 0, "desc" ]],
        "columns": [
	...
	$('.heading,.active').html('Lijst van alle personeel');

	oTable = $('#employee').DataTable({
        "processing": true,
        "serverSide": true,
		"language": {
			"search": "Zoeken in alle personeel:"
		  },
