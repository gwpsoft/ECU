...
<script type='text/javascript' src="{{ URL::asset('assets/js/jquery.dataTables.min.js') }}"></script>
 ...
 <title>Lijst van de Status Waarden</title>
     ...
     <div class="row">
            ...
            <div class="col-md-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Lijst van de Status Waarden</li>
   ...
   <div class="block">
                    ...
                    <div class="header">
                        ...
                        <div style="float:right"><a href=" <?php echo URL:: to( 'admin/create_status' ); ?> " class="btn btn-success">+ Nieuwe Status</a>
                    ...
                    <div class="content">
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" class="table table-bordered table-striped sortable" id="status">
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th width="15%">Omschrijving</th>

                                    <th width="15%">Afkorting</th>



                                   <th width="15%">Actief</th>
