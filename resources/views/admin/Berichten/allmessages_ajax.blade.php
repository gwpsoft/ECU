   ...
   @endif
            ...
            <?php if (!empty($All_Messages)) { ?>
                ...
                <div class="block block-drop-shadow">
                    <div class="header">
                        <h2>Messages</h2>
                        <div style="float:right"><a href=" <?php echo URL:: to( 'admin/EMPBerichten' ); ?> " class="btn btn-success">Sluiten</a></div>
                    </div>
                        ...
                        <?php 
                            ...
                            <input type="hidden" id="msg_<?php echo $message->msg_id?>" value="<?php echo $message->message?>" />
                                   ...
                                   <input type="hidden" id="ProjectName<?php echo $message->msg_id?>" value="<?php echo  @$GetProjectName->Name ; ?>" />
                                    <input type="hidden" id="ClientName<?php echo $message->msg_id?>" value="<?php echo  @$GetEmpName->Firstname.' '.@$GetEmpName->Lastname ; ?>" />
							...
							<?php echo Auth::user()->name;?></div>
                                ...
                                <?php } else {?>
                                 <div class="sender" style="float:<?=$float?>;margin-top: 12px;margin-left: -32px;font-weight:bold"><?php echo $GetEmpName->Firstname; ?></div>
                                <?php } ?>
                                ...
                                <a href="<?php echo URL:: to( 'admin/CheckedEMPMessage/'.$message->msg_id,1); ?>" class="btn btn-warning">Gezien</a>
                                <?php } else { 
                                ...
                                Beantwoord</a>
                                <?php } if (Auth::user()->group == 0 && $message->sender_id != $message->emp_id) {?>
