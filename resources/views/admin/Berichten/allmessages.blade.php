                ...
                <div class="block block-drop-shadow">
                    ...
                    <div class="content messages npr npt"> 
                        ...
                        <?php 
							...
							$counter++;
							@$GetEmpName = DB::table('tblemployee')->where('id',@$message->emp_id)->first();
							...
							if (Auth::user()->id != $message->sender_id) {
						 		$float='right'; $inbox = 'inbox'; $margin = 'margin-left:820px';
							} else {
								$float='left'; $inbox = ''; $margin = 'margin-left:630px !important';}
							?>
                            ...
                            <?php } else {?>
                            <div class="sender" style="float:<?=$float?>;margin-top: 12px;margin-left: -32px;font-weight:bold">
								 <?php echo $GetEmpName->Firstname; ?></div>
                                <?php } ?>
                                ...
                                <span style="<?=$margin?>">
                                <?php if (empty($CheckedByName) && $CustomerGroup ==  0) { ?>
                                ...
                                <?php if (empty($RepliedByName)) { ?>
                                <a data-toggle="modal" href="#" onclick="Edit('<?php echo $message->msg_id?>')" title="Toevoegen" class="btn btn-success">
                                Beantwoord</a>
                                <?php } else { 
